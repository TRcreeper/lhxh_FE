...
const updatePwd = async () => {
    ...
    let result = await updatePwdService(passwordModel.value)
    // ElMessage.success(result1.msg?result1.msg:'修改成功');

    const successMessage = (result.msg ? result.msg : '修改成功');
    ElMessage.success(successMessage);
            ...
            <el-col :span="12">
                <el-form :model="passwordModel" :rules="rules" label-width="100px" size="large">
                    ...
                    <el-form-item label="原密码">
                        <el-input v-model="passwordModel.old_pwd" type="password" placeholder="请输入原密码"
                            show-password></el-input>
                    </el-form-item>

                    <el-form-item label="新密码">
                        <el-input v-model="passwordModel.new_pwd" type="password" placeholder="请输入新密码"
                            show-password></el-input>
                    </el-form-item>

                    <el-form-item label="再次输入">
                        <el-input v-model="passwordModel.re_pwd" type="password" placeholder="请再次输入新密码"
                            show-password></el-input>
                    </el-form-item>
